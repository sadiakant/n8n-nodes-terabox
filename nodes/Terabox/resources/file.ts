...
export const fileFields: INodeProperties[] = [
	...
	},
	{
		...
		default: 0,
		description:
			'Max number of list results to return. Leave empty or set 0 to return all available results.',
	},
	{
	...
	},
	{
		...
		default: false,
		description:
			'Whether to return items outside the selected time filter instead of matching items',
	},
	{
	...
	// Download Fields
	{
		...
		default: '',
		description:
			'Absolute path of the file to download. Use {{ $JSON.path }} or {{ $JSON.list[0].path }} from a List node.',
	},
	// Metadata Fields
	{
	...
	},
	{
		...
		default: '',
		description:
			'New file/folder name for rename. If filelist contains objects with newname/newName, those values take priority.',
	},
	{
	...
	// Upload Fields
	{
		...
		description:
			'Absolute destination file path in TeraBox, including file name (example: /Photos/image.jpg)',
	},
	{
		displayName: 'Source',
		name: 'uploadSource',
